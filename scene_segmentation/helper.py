    ...
    def get_batches_fn(batch_size):
        ...
        for batch_i in range(0, len(image_paths), batch_size):
            ...
            for image_file in image_paths[batch_i:batch_i+batch_size]:
                ...
                # Load and resize images using PIL and imageio
                image = np.array(Image.fromarray(imageio.imread(image_file)).resize((image_shape[1], image_shape[0]), Image.Resampling.LANCZOS))
                gt_image = np.array(Image.fromarray(imageio.imread(gt_image_file)).resize((image_shape[1], image_shape[0]), Image.Resampling.LANCZOS))
